...
export default function MexicoCityGuide() {
  ...
  const allPlaces = [
    ...mexicoCityData.drinks_and_food.map((place) => ({
      ...place,
      categoryType: 'food',
    })),
    ...mexicoCityData.sightseeing.map((place) => ({
      ...place,
  ...
  return (
    <Layout>
      <SEO title="Mexico City Recommendations" />
      <div className={styles.container}>
        <main className={styles.main}>
          <h1 className={styles.title}>My Mexico City Travel Guide</h1>

          <p className={styles.description}>
            A collection of my favorite places in Mexico City, with personal
