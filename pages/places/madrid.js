...
export default function MadridGuide() {
  ...
  const allPlaces = [
    ...madridData.drinks_and_food.map((place) => ({
      ...place,
      categoryType: 'food',
    })),
    ...madridData.sightseeing.map((place) => ({
      ...place,
  ...
  return (
    <Layout>
      <SEO title="Madrid, Spain Recommendations" />
      <div className={styles.container}>
        <main className={styles.main}>
          <h1 className={styles.title}>My Madrid Travel Guide</h1>

          <p className={styles.description}>
            A collection of my favorite places in Madrid, Spain, with personal
